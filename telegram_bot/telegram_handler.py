...
class TelegramBotHandler:
    ...
    async def cmd_help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            logger.info(f"📋 Команда /help от user_id={user_id}, username={username}")
            ...
            text = (
                ...
                "• /enable SYMBOL — Включить пару\n"
                "• /disable SYMBOL — Отключить пару\n"
                "• /available — Популярные доступные пары\n\n"
                "*Экспорт данных:*\n"
                "• /export — Экспорт за 30 дней (все символы)\n"
                "• /export 7 — Экспорт за 7 дней\n"
                "• /export BTCUSDT — Экспорт BTCUSDT за 30 дней\n"
                "• /export ETHUSDT 60 — Экспорт ETHUSDT за 60 дней\n\n"
                "*Настройки:*\n"
    ...
    async def cmd_status(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # Получаем количество сигналов из БД
