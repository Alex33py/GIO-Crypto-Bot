...
# -*- coding: utf-8 -*-
"""
Тест Coinbase Connector
"""

import asyncio
from connectors.coinbase_connector import EnhancedCoinbaseConnector


async def test_coinbase():
    """Тестирование Coinbase API"""

    connector = EnhancedCoinbaseConnector()
    ...
    # Тест 4: Orderbook
    orderbook = await connector.get_orderbook("BTCUSDT", level=2)
    if orderbook:
